    ...
    (function(global, factory) {
      ...
      function leftButtonSelect(cm, event, start, behavior) {
        ...
        if (!behavior.addNew) {
          ...
          setSelection(doc2, normalizeSelection(cm, ranges.concat([ourRange]), ourIndex), {
            scroll: false,
            origin: "*mouse"
          });
        } else if (ranges.length > 1 && ranges[ourIndex].empty() && behavior.unit == "char" && !behavior.extend) {
          setSelection(doc2, normalizeSelection(cm, ranges.slice(0, ourIndex).concat(ranges.slice(ourIndex + 1)), 0), {
            scroll: false,
            origin: "*mouse"
          });
          startSel = doc2.sel;
        ...
        function extendTo(pos) {
          ...
          if (behavior.unit == "rectangle") {
            ...
            setSelection(doc2, normalizeSelection(cm, startSel.ranges.slice(0, ourIndex).concat(ranges2), ourIndex), {
              origin: "*mouse",
              scroll: false
            });
...
//# sourceMappingURL=codemirror-ACNCTYT2.js.map
